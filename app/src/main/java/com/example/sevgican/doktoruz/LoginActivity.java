...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            ...
            Log.e("Login Activity","cancel true olcak");
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            Log.e("Login Activity","burda hata var");

            focusView = mEmailView;
            cancel = true;
        } else if (!isEmailValid(email)) {
            Log.e("Login Activity","username valid degil");
        ...
        if (cancel) {
            ...
            Log.e("Login Activity","Cancel true oldu");

        } else {
            // Show a progress spinner, and kick off a background task to
            // perform the user login attempt.
            showProgress(true);
            Log.e("Login Activity","show progress geldi");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                sentence = "SELECT password FROM users WHERE username=\""+mEmail+"\"";

                outToServer.writeBytes(sentence + "\n");
                Log.e("Login Activity","out to server oldu");
                modifiedSentence = inFromServer.readLine();
                Log.e("Login Activity","json geldi.");
                ...
                Log.e("Login Activity","belki burda kucuk tatli bir exception vardir");
